...
impl GdbRemote {
    ...
    fn send_reply(&mut self, reply: Reply) -> GdbResult {
        let r = reply.into_packet();

        match self.remote.write(&r) {
    ...
    fn read_registers(&mut self, cpu: &mut Cpu) -> GdbResult {
        ...
        // see what registers it expects in the reply packet.
        ...
        for _ in 16..24 {
            // Send 96bit Fx registers
            reply.push(b"xxxxxxxxxxxxxxxxxxxxxxxx");
        }
    ...
    fn add_breakpoint(&mut self,
        ...
        // For a description of breakpoint "kinds" see
